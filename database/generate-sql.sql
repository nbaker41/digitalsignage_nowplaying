...
CONSTRAINT `FK_140` FOREIGN KEY `fkIdx_140` (`album_id`) REFERENCES `playlists` (`album_id`),
...
CREATE TABLE `playlists-directories`
(
 `album_id`     int NOT NULL ,
 `directory_id` int NOT NULL ,
 `user_id`      int NOT NULL ,
...
CONSTRAINT `FK_161` FOREIGN KEY `fkIdx_161` (`album_id`) REFERENCES `playlists` (`album_id`),
...
CONSTRAINT `FK_198` FOREIGN KEY `fkIdx_198` (`album_id`) REFERENCES `playlists` (`album_id`),
...
(
 ...
 `gt_id`                varchar(100) NOT NULL ,
 `avatar`               varchar(100) NULL ,
 `contact_phone_code`   int NULL ,
